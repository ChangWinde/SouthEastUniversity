		...
		<body style="display:flex; align-items; center; flex-direction:row; height:1000px; margin:0">
			...
			<div style="display:flex; position:relative; margin-left:100px">
				<p style="position:absolute; top:300px;left:70px; width:300px">
					<a href="qs2.xml"><img src="dataicon.svg" style="width:80px;"/></a>
					<a href="qc2.xml" style="margin-left:100px"><img src="advertiseicon.svg" style="width:80px;"/></a>
					<a href="query.xml" style="margin-left:80px"><img src="info.svg" style="width:80px;"/></a>
				</p>
